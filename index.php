...
<body>
      ...
      <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
        <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
          ...
          <div class="companylogo">
            ...
            <p class="companyintrotext">Purewish Foundation Uganda (PWFU) is an indigenous not for profit Christian Organization with a mission to empower and transform humanity to build for the future</p>
        ...
        <div class="col-md-4 d-flex align-self-stretch ftco-animate">
          <div class="media block-6  services p-3 py-4 d-block">
            ...
            <div class="gridcenter media-body">
              ...
              <p class="gridcenter">PWFU is a youth led and focused NGO registered with Government of Uganda and mandated to raise the generation of children, youth and women who are academically, spiritually and economically empowered to lead their communities to fight poverty, ignorance and mind change.
              </p>
            </div>
          </div>
        </div>
  ...
  <div class="container">
    <h1 style="text-align:center;margin-top:-100px;">News Updates</h1>
    <form action="">
      <textarea class="" name="" id="" cols="40" rows="10" style="margin-left:100px;"></textarea>
      &nbsp;&nbsp;&nbsp;&nbsp;<textarea class="" name="" id="" cols="40" rows="10"></textarea>
    </form><br><br>
  </div>
  
   <div class="grid-container">
        <div class="grid-item">
             <iframe style="display:flex" justify-content:"center" width="auto" height="315" src="https://www.youtube.com/embed/YSYEsb7tYU4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
             
                     </div>
        <div class="grid-item">
            
            <iframe style="display:flex" justify-content:"center" width="auto" height="315" src="https://www.youtube.com/embed/0VQ5OUzohbc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="grid-item">
            
            <iframe style="display:flex" justify-content:"center" width="auto" height="315" src="https://www.youtube.com/embed/EGVxSWh6Ec4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
          <div class="staff">
            <!-- <span class="position">Keving recived brand new sewing machine after completing her traing for 6 month.</span> <br><br> -->
            <img src="images/test1.jpg" class="md-2" height="200px" width="200px" alt=""> <br>
            <div class="d-flex mb-5">
              <div>
                <h3><a href="#">Judith</a></h3>
                <p><b>She</b> received her cerficate of completion after six month training in tailering and garment cutting.</p>
                <!-- <span class="position"></span> -->
                <div class="text">
                  <p>Judith is a teenage school dropout girl who never thought of training or learning any skills because of her poor academic background
                  </p>
                  <!-- <p>Donated <span>$300</span> for <a href="#">Children Needs Food</a></p> -->
                </div>
              </div>
        ...
        <div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
          <div class="staff">
            <!-- <span class="position">Keving recived brand new sewing machine after completing her traing for 6 month.</span> <br><br> -->
            <img src="images/test3.jpg" class="md-2" height="200px" width="280px" alt=""> <br>
            <div class="d-flex mb-5">
              <div>
                <h3><a href="#">Graduates</a></h3>
                <p>School dropout girls received their certificates of completion after six months of training in tailering and garment cutting</p>
                <!-- <span class="position"></span> -->
                <div class="text">
                  <p>Lydia is a teenage school dropout girl who never thought of training or learning any skills because of her poor academic background
                  </p>
                  <!-- <p>Donated <span>$300</span> for <a href="#">Children Needs Food</a></p> -->
                </div>
              </div>
        ...
        <div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
          <div class="staff">
            <!-- <span class="position">Keving recived brand new sewing machine after completing her traing for 6 month.</span> <br><br> -->
            <img src="images/test2.jpg" class="md-2" height="200px" width="280px" alt=""> <br>
            <div class="d-flex mb-5">
              <div>
                <h3><a href="#">Lydia</a></h3>
                <p> She received her cerficate of completion after six month training in tailering and garment cutting.</p>
                <!-- <span class="position"></span> -->
                <div class="text">
                  <p>
                  </p>
      ...
      <div class="row mb-5">
        <div class="col-md-7">
          <div class="ftco-footer-widget mb-4">
            ...
            <p>Purewish Foundation Uganda (PWFU) is an indigenous not for profit Christian Organization which was founded in 2014 and first registered as CBO with Lira district Local government in Uganda.</p>
